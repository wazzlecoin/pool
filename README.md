Wazzle Mining Pool based on Yiimp
...
5. cd ~/
6. `wget https://raw.githubusercontent.com/wazzle/pool/next/install.sh && chmod +x install.sh && ./install.sh`
...
Thanks to oakey22 for customising this for Wazzle.
Thanks to imskaa for customising this for Wazzle.
