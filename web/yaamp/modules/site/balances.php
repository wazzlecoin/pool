...
<p class="notes">This table show all non-zero balances tracked by Wazzle Community Pool. It also allow manual API calls to manually check the exchange API reliability</p>
